...
```{r, echo=FALSE, warning=FALSE}
  ...
  scale_fill_manual(values = c("darkblue", "darkgoldenrod1", "darkseagreen", "darkorchid", "darkolivegreen1", "lightskyblue", "darkgreen", "deeppink", "khaki2", "firebrick", "brown1", "darkorange1", "cyan1", "royalblue4", "darksalmon", "darkblue","royalblue4", "dodgerblue3", "steelblue1", "lightskyblue", "darkseagreen", "darkgoldenrod1", "darkseagreen", "darkorchid", "darkolivegreen1", "brown1", "darkorange1", "cyan1", "darkgrey")) + theme(axis.text = element_text(size = 7, colour="black"))
```
...
#FITTING7: regulate the bar height if it has replicates
  ...
  otu_table(ps.ng.tax_most_swab_)[,c("p3.swab.d75")] <- otu_table(ps.ng.tax_most_swab_)[,c("p3.swab.d75")]/4
  ...
  otu_table(ps.ng.tax_most_swab_)[,c("H49.swab.41")] <- otu_table(ps.ng.tax_most_swab_)[,c("H49.swab.41")]/2
  otu_table(ps.ng.tax_most_swab_)[,c("H49.swab.42")] <- otu_table(ps.ng.tax_most_swab_)[,c("H49.swab.42")]/2
...
p2 <- p + stat_compare_means(
  ...
  comparisons = list(c("-","0"),c("-","07"),c("-","14"),c("-","21"),c("-","28"),  c("0","07"),c("0","14"),c("0","21"),c("0","28"),  c("07","14"),c("07","21"),c("07","28"), c("14","21"),c("14","28"),   c("21","28")), 
  label = "p.signif",
  symnum.args <- list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")),
  hide.ns = TRUE
)
...
Alpha diversity by RoundDay for the patient1_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p1_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p1_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p1_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p1_stool.png")
```

Alpha diversity by RoundDay for the patient2_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p2_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p2_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p2_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p2_stool.png")
```

Alpha diversity by RoundDay for the patient3_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p3_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p3_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p3_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p3_stool.png")
```

Alpha diversity by RoundDay for the patient4_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p4_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p4_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p4_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p4_stool.png")
```

Alpha diversity by RoundDay for the patient5_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p5_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p5_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p5_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p5_stool.png")
```

Alpha diversity by RoundDay for the patient6_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p6_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p6_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p6_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p6_stool.png")
```


Alpha diversity by RoundDay for the patient7_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p7_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p7_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p7_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p7_stool.png")
```


Alpha diversity by RoundDay for the patient8_stool samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_stool/adiv_even_p8_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p8_stool.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p8_stool.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p8_stool.png")
```


Alpha diversity by RoundDay for the patient1_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p1_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p1_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p1_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p1_swab.png")
```

Alpha diversity by RoundDay for the patient2_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p2_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p2_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p2_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p2_swab.png")
```

Alpha diversity by RoundDay for the patient3_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p3_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p3_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p3_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p3_swab.png")
```

Alpha diversity by RoundDay for the patient4_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p4_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p4_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p4_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p4_swab.png")
```

Alpha diversity by RoundDay for the patient5_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p5_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p5_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p5_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p5_swab.png")
```

Alpha diversity by RoundDay for the patient6_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p6_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p6_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p6_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p6_swab.png")
```


Alpha diversity by RoundDay for the patient7_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p7_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p7_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p7_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p7_swab.png")
```


Alpha diversity by RoundDay for the patient8_swab samples
```{r, echo=FALSE, warning=FALSE}
hmp.div_qiime <- read.csv("../core_diversity_e4753_swab/adiv_even_p8_.txt", sep="\t") 
colnames(hmp.div_qiime) <- c("sam_name", "chao1", "observed_otus", "shannon", "PD_whole_tree")
row.names(hmp.div_qiime) <- hmp.div_qiime$sam_name
div.df <- merge(hmp.div_qiime, hmp.meta, by = "sam_name")
div.df2 <- div.df[, c("RoundDay", "chao1", "shannon", "observed_otus", "PD_whole_tree")]
...
ggsave("./figures/alpha_diversity_RoundDay_p8_swab.png", device="png", height = 10, width = 12)
ggsave("./figures/alpha_diversity_RoundDay_p8_swab.svg", device="svg", height = 10, width = 12)
# send both png and svg files to Laura
```
```{r, echo=FALSE, warning=FALSE, fig.cap="Alpha diversity", out.width = '100%', fig.align= "center"}
knitr::include_graphics("./figures/alpha_diversity_RoundDay_p8_swab.png")
```
...
unwt.unifrac <- unwt.unifrac + theme_classic() + scale_color_brewer("Patient", palette = "Set3")  #    #mycolors
#print(unwt.unifrac)
